...
macro(_omni_checkhealth)
    ...
    set(_omni_comp_db "${CMAKE_BINARY_DIR}/compile_commands.json")
    if(NOT EXISTS "${_omni_comp_db}")
        message(STATUS
            "omnirefl: compile_commands.json not found yet at `${_omni_comp_db}`; "
            "it will be generated by CMake.")
    endif()
endmacro()
